 ...
 * [OUTPUT]: 对外提供 iframe 内受控资源详情模态框、删除确认入口与带真实媒体缩略图的新建资源弹窗；Brief 表单收集选题方向、细节描述与预期时长，并只构建可复制的 Agent Prompt
